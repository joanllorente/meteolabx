...
test('los favoritos antiguos se traducen a la URL de su ficha', async () => {
  globalThis.localStorage = almacen({
    meteolabx_favorites: JSON.stringify([
      { provider_id: 'AEMET', station_id: '0201X', station_name: 'Barcelona - Drassanes' },
      { provider_id: 'NETATMO', station_id: '70:ee:50:af:85:02', station_name: 'Rue Domat' }
    ])
  });
...
test('las credenciales y la autoconexión se traen tal cual', async () => {
  globalThis.localStorage = almacen({
    ...
    meteolabx_active_z: '39',
    meteolabx_weatherlink_api_key: 'wl-clave',
    meteolabx_weatherlink_api_secret: 'wl-secreto',
