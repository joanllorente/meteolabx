...
<section class="forecast-head">
  ...
  <div class="run-status">
    ...
    <div><small>{catalogError ? 'Backend AROME no disponible' : 'Último RUN disponible'}</small><strong>{catalogError ? 'Pulsa para reintentar' : catalog ? latestRunLabel : 'Conectando…'}</strong></div>
